...
module top ;
	...
	wire [0:0] tmpOE__ResetPin_net;
	wire [0:0] tmpIO_0__ResetPin_net;
	wire [0:0] tmpINTERRUPT_0__ResetPin_net;
	electrical [0:0] tmpSIOVREF__ResetPin_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("8d318d8b-cf7b-4b6b-b02c-ab1c5c49d0ba"),
		  ...
		  .input_buffer_sel(2'b00))
		ResetPin
		 (.oe(tmpOE__ResetPin_net),
		  .y({1'b0}),
		  .fb({Net_303}),
		  .io({tmpIO_0__ResetPin_net[0:0]}),
		  .siovref(tmpSIOVREF__ResetPin_net),
		  .interrupt({tmpINTERRUPT_0__ResetPin_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__ResetPin_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__ResetPWM_net;
	wire [0:0] tmpFB_0__ResetPWM_net;
	wire [0:0] tmpIO_0__ResetPWM_net;
	wire [0:0] tmpINTERRUPT_0__ResetPWM_net;
	electrical [0:0] tmpSIOVREF__ResetPWM_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("e851a3b9-efb8-48be-bbb8-b303b216c393"),
		  ...
		  .input_buffer_sel(2'b00))
		ResetPWM
		 (.oe(tmpOE__ResetPWM_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__ResetPWM_net[0:0]}),
		  .io({tmpIO_0__ResetPWM_net[0:0]}),
		  .siovref(tmpSIOVREF__ResetPWM_net),
		  .interrupt({tmpINTERRUPT_0__ResetPWM_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__ResetPWM_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
